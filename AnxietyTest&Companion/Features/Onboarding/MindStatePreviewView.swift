    ...
    var body: some View {
        ZStack {
            ...
            ScrollView {
                VStack(spacing: 10) {
                    // Title
                    Text(String(localized: "mindstate_title"))
                    ...
                    // Subtitle
                    Text(String(localized: "mindstate_subtitle"))
                    ...
                    ChartSection(
                        title: showImprovedState ? String(localized: "mindstate_chart_with_tracking") : String(localized: "mindstate_chart_without_tracking"),
                        subtitle: showImprovedState
                            ? String(localized: "mindstate_chart_with_tracking_subtitle")
                            : String(localized: "mindstate_chart_without_tracking_subtitle"),
                    ...
                    LazyVGrid(columns: [GridItem(.flexible()), GridItem(.flexible())], spacing: 16) {
                        StatCard(icon: "😰", title: String(localized: "mindstate_stat_anxious_thoughts"), value: anxiousThoughtsValue)
                        StatCard(icon: "💭", title: String(localized: "mindstate_stat_mind_clarity"), value: mindClarityValue)
                        StatCard(icon: "🧘‍♀️", title: String(localized: "mindstate_stat_calm_moments"), value: calmMomentsValue)
                        StatCard(icon: "💗", title: String(localized: "mindstate_stat_self_compassion"), value: selfCompassionValue)
                    }
                    ...
                    if !isCompleted {
                        VStack(spacing: 12) {
                            Text(pressInProgress ? String(localized: "mindstate_keep_holding") : String(localized: "mindstate_hold_to_see"))
                        ...
                        Button(action: {
                            ...
                            Text(String(localized: "mindstate_continue_button"))
                                .font(.system(.body, design: .rounded))
                                .fontWeight(.medium)
                                .foregroundColor(.themeText)
